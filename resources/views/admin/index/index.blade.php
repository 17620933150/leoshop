...
@section('title')在线教育首页@endsection
@section('content')
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="{{ url('Admin/subject') }}" data-title="学科管理" href="javascript:void(0)">学科管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="{{ url('Admin/profession') }}" data-title="专业管理" href="javascript:void(0)">专业管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-article">
		...
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> 直播课程<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="{{ url('Admin/stream') }}" data-title="直播流" href="javascript:void(0)">直播流</a></li>
					<li><a data-href="{{ url('Admin/live') }}" data-title="直播课程" href="javascript:void(0)">直播课程</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">

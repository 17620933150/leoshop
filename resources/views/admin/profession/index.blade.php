...
@section('title')专业管理 - 专业列表@endsection
@section('content')
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()"
                            ...
                            class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;"
                                                                          onclick="profession_add('添加专业','{{ url('Admin/profession/create') }}','800','500')"
                                                                          class="btn btn-primary radius"><i
                            class="Hui-iconfont">&#xe600;</i> 添加专业</a></span> <span class="r">共有数据：<strong>54</strong> 条</span>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#table').DataTable({
                ...
                //使用ajax获取服务器的数据
                ajax: {
                    url: "{{ url("api/Admin/profession/ajax_list") }}",
                    type: "GET",
                ...
                createdRow: function(row, data, dataIndex){
                    ...
                    $(row).children().eq(-1).html('<a title="编辑" href="javascript:;" onclick="profession_edit(\'专业编辑\',\'admin-add.html\',\''+data.id+'\',\'800\',\'500\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="profession_del(this,\''+data.id+'\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>');
                    
                    if(data.cover){
                        $(row).children().eq(3).html('<img height="50" src="'+data.cover+'" alt="" />');
                    }else{
        ...
        */
        ...
        function profession_stop(obj, id) {
            layer.confirm('确认要停用吗？', function (index) {
                ...
                $(obj).parents("tr").find(".td-manage").prepend('<a onClick="profession_start(this,id)" href="javascript:;" title="启用" style="text-decoration:none"><i class="Hui-iconfont">&#xe615;</i></a>');
        ...
        function profession_start(obj, id) {
            layer.confirm('确认要启用吗？', function (index) {
                ...
                $(obj).parents("tr").find(".td-manage").prepend('<a onClick="profession_stop(this,id)" href="javascript:;" title="停用" style="text-decoration:none"><i class="Hui-iconfont">&#xe631;</i></a>');

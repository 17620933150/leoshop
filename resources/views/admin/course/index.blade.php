...
@section('title')点播课程 - 课程列表@endsection
@section('content')
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()"
                            ...
                            class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;"
                                                                          onclick="course_add('添加课程','{{ url('Admin/course/create') }}','800','500')"
                                                                          class="btn btn-primary radius"><i
                            class="Hui-iconfont">&#xe600;</i> 添加课程</a></span> <span class="r">共有数据：<strong>54</strong> 条</span>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#table').DataTable({
                ...
                //使用ajax获取服务器的数据
                ajax: {
                    url: "{{ url("api/Admin/course/ajax_list") }}",
                    type: "GET",
                ...
                createdRow: function(row, data, dataIndex){
                    ...
                    $(row).children().eq(-1).html('<a title="编辑" href="javascript:;" onclick="course_edit(\'专业编辑\',\'admin-add.html\',\''+data.id+'\',\'800\',\'500\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="course_del(this,\''+data.id+'\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>');
        ...
        */
        ...
        function course_stop(obj, id) {
            layer.confirm('确认要停用吗？', function (index) {
                ...
                $(obj).parents("tr").find(".td-manage").prepend('<a onClick="course_start(this,id)" href="javascript:;" title="启用" style="text-decoration:none"><i class="Hui-iconfont">&#xe615;</i></a>');
        ...
        function course_start(obj, id) {
            layer.confirm('确认要启用吗？', function (index) {
                ...
                $(obj).parents("tr").find(".td-manage").prepend('<a onClick="course_stop(this,id)" href="javascript:;" title="停用" style="text-decoration:none"><i class="Hui-iconfont">&#xe631;</i></a>');

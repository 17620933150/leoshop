...
<article class="page-container">
	<form action="{{ url('Admin/subject') }}" method="post" class="form form-horizontal" id="form-add-subject">
		{{ csrf_field() }}
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>学科名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" name="subject_name" id="subject">
			</div>
		</div>
		<div class="row cl">

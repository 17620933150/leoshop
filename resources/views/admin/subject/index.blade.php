...
@section('title')学科管理 - 学科列表@endsection
@section('content')
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 学科管理 <span
                class="c-gray en">&gt;</span> 学科列表 <a class="btn btn-success radius r"
    ...
    <div class="page-container">
        <div class="text-c"> 日期范围：
            ...
            <input type="text" class="input-text" style="width:250px" placeholder="输入学科名称" id="" name="">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()"
                            ...
                            class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;"
                                                                          onclick="subject_add('添加学科','{{ url('Admin/subject/create') }}','800','500')"
                                                                          class="btn btn-primary radius"><i
                            class="Hui-iconfont">&#xe600;</i> 添加学科</a></span> <span class="r">共有数据：<strong>54</strong> 条</span>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#table').DataTable({
                ...
                //使用ajax获取服务器的数据
                ajax: {
                    url: "{{ url("api/Admin/subject/ajax_list") }}",
                    type: "GET",
                ...
                createdRow: function(row, data, dataIndex){
                    ...
                    $(row).children().eq(-1).html('<a title="编辑" href="javascript:;" onclick="subject_edit(\'学科编辑\',\'admin-add.html\',\''+data.id+'\',\'800\',\'500\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="subject_del(this,\''+data.id+'\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>');
